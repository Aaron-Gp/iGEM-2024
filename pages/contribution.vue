<template>
    <div class="page-title m-10 mb-16 font-normal text-3xl p-5 pl-8 rounded-lg">Contribution</div>
    <div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10">
        <ContentDoc path="/team-contribution" v-slot="{ doc }">
            <!-- TOC -->
            <aside class="md:sticky md:top-[18vh] md:w-[200px] md:h-[450px] md:mr-10 ">
