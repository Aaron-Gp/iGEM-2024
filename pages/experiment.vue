<template>
    ...
    <div class="page-title m-10 mb-16 font-normal text-3xl p-5 rounded-lg">Experiments</div>
    <div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10">
        <ContentDoc path="/wetlab-experiment" v-slot="{ doc }">
            <!-- TOC -->
            <aside class="md:sticky md:top-[120px] md:w-[200px] md:h-[250px] md:mr-10 ">
