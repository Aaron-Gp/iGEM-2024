import _sfc_main$1 from './ContentDoc-Shjs9vyD.mjs';
import _sfc_main$2 from './ContentRenderer-DzIPVf2e.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "BIT iGEM 2024 - Contribution",
      meta: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="page-title m-10 mb-16 font-normal text-3xl p-5 pl-8 rounded-lg">Contribution</div><div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10">`);
      _push(ssrRenderComponent(_component_ContentDoc, { path: "/team-contribution" }, {
        default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="md:sticky md:top-[18vh] md:w-[200px] md:h-[450px] md:mr-10"${_scopeId}><h1 class="mt-0"${_scopeId}>TOC</h1><ul${_scopeId}><!--[-->`);
            ssrRenderList(doc.body.toc.links, (link) => {
              _push2(`<li class="${ssrRenderClass([{ "text-[#C0F748] font-bold": unref(activateIndex) == link.id }, "my-5"])}"${_scopeId}><a class="cursor-pointer"${_scopeId}>${ssrInterpolate(link.text)}</a></li>`);
            });
            _push2(`<!--]--></ul></aside>`);
            ...
            return [
              createVNode("aside", { class: "md:sticky md:top-[18vh] md:w-[200px] md:h-[450px] md:mr-10" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/contribution.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=contribution-DCASrNYf.mjs.map
