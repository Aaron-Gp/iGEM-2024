...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="page-title m-10 mb-16 font-normal text-3xl p-5 pl-8 rounded-lg">Safety</div><div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10">`);
      _push(ssrRenderComponent(_component_ContentDoc, { path: "/project-safety" }, {
...
//# sourceMappingURL=safety-BCeOxVxU.mjs.map
