...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "BIT iGEM 2024 - Description",
      meta: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="page-title m-10 mb-16 font-normal text-3xl p-5 pl-8 rounded-lg">Description</div><div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10">`);
      _push(ssrRenderComponent(_component_ContentDoc, { path: "/project-description" }, {
        default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="md:sticky md:top-[120px] md:w-[200px] md:h-[300px] md:mr-10"${_scopeId}><h1 class="mt-0"${_scopeId}>TOC</h1><ul${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("aside", { class: "md:sticky md:top-[120px] md:w-[200px] md:h-[300px] md:mr-10" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/description.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=description-U8rbIa6W.mjs.map
