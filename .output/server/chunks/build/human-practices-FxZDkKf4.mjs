...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="page-title m-10 mb-16 font-normal text-3xl p-5 pl-8 rounded-lg" data-v-0156a899>Integrated HP</div><div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10" data-v-0156a899>`);
      _push(ssrRenderComponent(_component_ContentDoc, { path: "/hp-ihp" }, {
        default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="md:sticky md:top-[120px] md:w-[200px] md:h-[400px] md:mr-10" data-v-0156a899${_scopeId}><h1 class="" data-v-0156a899${_scopeId}>TOC</h1><ul data-v-0156a899${_scopeId}><!--[-->`);
            ssrRenderList(doc.body.toc.links, (link) => {
              _push2(`<li class="${ssrRenderClass([{ "text-[#C0F748] font-bold": unref(activateIndex) == link.id }, "my-5"])}" data-v-0156a899${_scopeId}><a class="cursor-pointer" data-v-0156a899${_scopeId}>${ssrInterpolate(link.text)}</a><ul class="${ssrRenderClass([{ "hidden": unref(activateIndex) != link.id }, "pl-5 pt-2"])}" data-v-0156a899${_scopeId}><!--[-->`);
              ssrRenderList(link.children, (sublink) => {
                _push2(`<!--[-->`);
                if (sublink.depth == 3) {
                  _push2(`<li class="${ssrRenderClass([{ "text-[#fff] font-normal": unref(activateSubIndex) != sublink.id }, "mb-2 text-sm xl:text-base"])}" data-v-0156a899${_scopeId}><a class="cursor-pointer" data-v-0156a899${_scopeId}>${ssrInterpolate(sublink.text)}</a></li>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<!--]-->`);
            ...
            return [
              createVNode("aside", { class: "md:sticky md:top-[120px] md:w-[200px] md:h-[400px] md:mr-10" }, [
                createVNode("h1", { class: "" }, "TOC"),
                createVNode("ul", null, [
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(link.children, (sublink) => {
                          return openBlock(), createBlock(Fragment, {
                            ...
                            sublink.depth == 3 ? (openBlock(), createBlock("li", {
                              key: 0,
                              class: [{ "text-[#fff] font-normal": unref(activateSubIndex) != sublink.id }, "mb-2 text-sm xl:text-base"]
                            }, [
                              createVNode("a", {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/human-practices.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const humanPractices = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0156a899"]]);

export { humanPractices as default };
//# sourceMappingURL=human-practices-FxZDkKf4.mjs.map
