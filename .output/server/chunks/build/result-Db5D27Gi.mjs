...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="page-title m-10 mb-16 font-normal text-3xl p-5 pl-8 rounded-lg" data-v-0a95154d>Results</div><div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10" data-v-0a95154d>`);
      _push(ssrRenderComponent(_component_ContentDoc, { path: "/wetlab-results" }, {
        default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="md:sticky md:top-[120px] md:w-[200px] md:h-[400px] md:mr-10" data-v-0a95154d${_scopeId}><h1 class="mt-0" data-v-0a95154d${_scopeId}>TOC</h1><ul data-v-0a95154d${_scopeId}><!--[-->`);
            ssrRenderList(doc.body.toc.links, (link) => {
              _push2(`<li class="${ssrRenderClass([{ "text-[#C0F748] font-bold": unref(activateIndex) == link.id }, "my-5"])}" data-v-0a95154d${_scopeId}><a class="cursor-pointer" data-v-0a95154d${_scopeId}>${ssrInterpolate(link.text)}</a></li>`);
            });
            _push2(`<!--]--></ul></aside>`);
...
const result = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0a95154d"]]);

export { result as default };
//# sourceMappingURL=result-Db5D27Gi.mjs.map
