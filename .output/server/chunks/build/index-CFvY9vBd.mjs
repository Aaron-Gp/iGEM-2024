import { watch, defineComponent, ref, computed, provide, renderSlot, inject, openBlock, createElementBlock, normalizeClass, unref, normalizeStyle, withDirectives, cloneVNode, Fragment, Text, Comment, createVNode, createBlock, mergeProps, withCtx, createCommentVNode, toRef, Transition, vShow, readonly, toDisplayString, createTextVNode, getCurrentScope, onScopeDispose, createElementVNode, getCurrentInstance, nextTick, shallowRef, Teleport as Teleport$1, warn } from 'vue';
import { fromPairs, isNil, pick, isUndefined } from 'lodash-unified';
import { isString as isString$1, NOOP, isObject, hasOwn, isFunction, isArray } from '@vue/shared';
import { k as isNumber, l as isStringNumber, j as useNamespace, s as useId, o as isBoolean, p as useGetDerivedNamespace, q as useIdInjection, r as useZIndex } from './server.mjs';
...
var ElFocusTrap = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$2], ["__file", "focus-trap.vue"]]);
...
export { ElPopover as E, _export_sfc as _, addUnit as a, buildProps as b, arrow_down_default as c, definePropType as d, arrow_right_default as e, ElTooltip as f, withNoopInstall as g, addClass as h, iconPropType as i, hasClass as j, useTimeoutFn as k, menu_default as l, more_default as m, removeClass as r, useResizeObserver as u, withInstall as w };
//# sourceMappingURL=index-CFvY9vBd.mjs.map
