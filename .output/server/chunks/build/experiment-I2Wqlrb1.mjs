...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "BIT iGEM 2024 - Experiments",
      meta: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="page-title m-10 mb-16 font-normal text-3xl p-5 rounded-lg" data-v-651baa18>Experiments</div><div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10" data-v-651baa18>`);
      _push(ssrRenderComponent(_component_ContentDoc, { path: "/wetlab-experiment" }, {
        default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="md:sticky md:top-[120px] md:w-[200px] md:h-[250px] md:mr-10" data-v-651baa18${_scopeId}><h1 class="mt-0" data-v-651baa18${_scopeId}>TOC</h1><ul data-v-651baa18${_scopeId}><!--[-->`);
            ssrRenderList(doc.body.toc.links, (link) => {
              _push2(`<li class="${ssrRenderClass([{ "text-[#C0F748] font-bold": unref(activateIndex) == link.id }, "my-4"])}" data-v-651baa18${_scopeId}><a class="cursor-pointer" data-v-651baa18${_scopeId}>${ssrInterpolate(link.text)}</a><ul class="${ssrRenderClass([{ "hidden": unref(activateIndex) != link.id }, "pl-5 pt-2"])}" data-v-651baa18${_scopeId}><!--[-->`);
              ssrRenderList(link.children, (sublink) => {
                _push2(`<!--[-->`);
                if (sublink.depth == 3) {
                  _push2(`<li class="${ssrRenderClass([{ "text-[#fff] font-normal": unref(activateSubIndex) != sublink.id }, "mb-2"])}" data-v-651baa18${_scopeId}><a class="cursor-pointer" data-v-651baa18${_scopeId}>${ssrInterpolate(sublink.text)}</a></li>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<!--]-->`);
            ...
            return [
              createVNode("aside", { class: "md:sticky md:top-[120px] md:w-[200px] md:h-[250px] md:mr-10" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/experiment.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const experiment = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-651baa18"]]);

export { experiment as default };
//# sourceMappingURL=experiment-I2Wqlrb1.mjs.map
