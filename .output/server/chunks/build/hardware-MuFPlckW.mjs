...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="page-title m-10 mb-16 font-normal text-3xl p-5 pl-8 rounded-lg" data-v-da2ffda7>Hardware</div><div class="flex flex-row flex-wrap md:flex-nowrap justify-center mx-10" data-v-da2ffda7>`);
      _push(ssrRenderComponent(_component_ContentDoc, { path: "/drylab-hardware" }, {
        default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="md:sticky md:top-[120px] md:w-[200px] md:h-[500px] md:mr-10" data-v-da2ffda7${_scopeId}><h1 class="mt-0" data-v-da2ffda7${_scopeId}>TOC</h1><ul data-v-da2ffda7${_scopeId}><!--[-->`);
            ssrRenderList(doc.body.toc.links, (link) => {
              _push2(`<li class="${ssrRenderClass([{ "text-[#C0F748] font-bold": unref(activateIndex) == link.id }, "my-4"])}" data-v-da2ffda7${_scopeId}><a class="cursor-pointer" data-v-da2ffda7${_scopeId}>${ssrInterpolate(link.text)}</a></li>`);
            });
            _push2(`<!--]--></ul></aside>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/hardware.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const hardware = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-da2ffda7"]]);

export { hardware as default };
//# sourceMappingURL=hardware-MuFPlckW.mjs.map
