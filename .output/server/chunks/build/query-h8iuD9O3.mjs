...
import { e as asyncDataDefaults, d as useNuxtApp, c as createError, b as useRuntimeConfig, f as useRequestEvent } from './server.mjs';
import { H as withLeadingSlash, j as joinURL, D as withoutTrailingSlash, I as withBase, E as hash } from '../runtime.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BBzf3YLW.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-h8iuD9O3.mjs.map
